...
var qtgt = new Vue({
    ...
    methods:{
        ...
        addI1(){this.data1.push({machiphi:1,soluong:1});},
        ...
        addI2(){this.data2.push({machiphi:1,soluong:1});},
        ...
        addI3(){this.data3.push({machiphi:1,soluong:1});},
        ...
        addI4(){this.data4.push({machiphi:1,soluong:1});},
        ...
        addI5(){this.data5.push({machiphi:'tl1',sl_oc:0,sl_on:0});},
    ...
    computed:{
        ...
        chiphi(){
            let dataChiphi='{'+
            '"dc1":{"diengiai":"gạch terrazo","dvt":"m2"},'+
            '"dc2":{"diengiai":"Nhựa dày 10cm","dvt":"m2"},'+
            '"dc3":{"diengiai":"Bê tông xi măng","dvt":"m2"},'+
            '"vl1":{"diengiai":"gạch terrazo","dvt":"m2"},'+
            '"vl2":{"diengiai":"Nhựa dày 10cm","dvt":"m2"},'+
            '"vl3":{"diengiai":"Bê tông xi măng","dvt":"m2"},'+
            '"tl1":{"diengiai":"gạch terrazo","dvt":"m2"},'+
            '"tl2":{"diengiai":"Nhựa dày 10cm","dvt":"m2"},'+
            '"tl3":{"diengiai":"Bê tông xi măng","dvt":"m2"}'+
            '}';
            return JSON.parse(dataChiphi)
        },
        baogia(){
            let dataBaogia='{'+
        ...
        n_vl(){let total = 0;
            for (let i = 0; i < this.data3.length; i++) {
                let s=this.data3[i];
                try{s.dvt=this.chiphi[s.machiphi].dvt}catch(e){s.dvt=''};
    ...
    data() {return{
        ...
        data5:[
            {machiphi:'tl1',sl_oc:1,sl_on:1},
            {machiphi:'tl2',sl_oc:2,sl_on:0},
            {machiphi:'tl3',sl_oc:0,sl_on:3}
        ]
    }}
});
